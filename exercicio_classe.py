class PassagemAerea:
    def __init__(self, tarifas, vantagens):
...
class ClasseEconomy(PassagemAerea):
    def __init__(self, tarifas, vantagens, tipo_de_trecho):
        self.tipo_de_trecho = tipo_de_trecho
        super().__init__(tarifas, vantagens)
...
print('A classe mais básica é a', classe1.tarifas, 'suas vantagens são', classe1.vantagens,'. É possível voar nessa classe em trechos ', classe1.tipo_de_trecho)
print('Essa classe', classe1.preco())

classe2 = PremiumEconomy('Premium Economy', 'preço e confortos extras')
print('A segunda classe mais básica é a', classe2.tarifas, 'suas vantagens são', classe2.vantagens,'.')
